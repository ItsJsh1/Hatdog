@extends('layouts.app')
@section('content')
@vite(['resources/css/regularMember.css'])
@vite(['resources/js/regularMembers.js'])

<!-- HERO SECTION -->
<section class="relative w-full h-[500px] bg-fixed bg-center bg-cover bg-[url('{{ asset('images/home/regularMembership/RegularMembership.png') }}')]">
